    ...
    "services": [
        {
            ...
            "description": "End-to-end web application development using modern technologies like Node.js, Express, and React. Building scalable, secure, and high-performance solutions tailored to your business needs."
        },
        {
            "icon": "fas fa-server",
            "title": "Backend & API Architecture",
            "description": "Designing robust RESTful APIs and server-side logic. Expertise in database design (MySQL, MongoDB) and implementing secure authentication systems (JWT, OAuth)."
        },
        {
            "icon": "fas fa-mobile-alt",
            "title": "Responsive UI/UX Design",
            "description": "Creating engaging, mobile-first interfaces that provide seamless user experiences across all devices. Focusing on accessibility, performance, and modern design principles."
        },
        {
            "icon": "fas fa-chart-line",
            "title": "Technical Consulting & SEO",
            "description": "Providing technical guidance on software architecture, code quality, and performance optimization. Implementing SEO best practices to improve search engine visibility."
        }
    ],
    "about": {
        "name": "Martin O",
        "role": "Full-Stack Developer specializing in Node.js, Express & Secure Web Applications",
        "heroDescription": "Professional web developer with 5+ years of experience building scalable, secure web applications using modern JavaScript technologies. Expert in Node.js, Express.js, MySQL, MongoDB, and RESTful API development.",
        "profileImage": "./resource/profile/image.png",
        "bio": "I'm a passionate full-stack web developer with over 2 years of experience building robust web applications. My expertise lies in creating secure, scalable solutions using modern technologies. I specialize in Express.js, EJS templating, and implementing secure authentication systems with bcrypt. I believe in writing clean, maintainable code and following best practices for web development. When I'm not coding, I enjoy contributing to open-source projects, writing technical blogs, and exploring new technologies in the web development ecosystem.",
        "skills": [
            {
                "icon": "fab fa-node-js",
            ...
            },
            {
                ...
                "description": "Designing schemas with MySQL and MongoDB"
            },
            {
                "icon": "fab fa-js",
                "title": "Modern JavaScript",
                "description": "ES6+, Async/Await, and modular coding patterns"
            },
            {
                "icon": "fas fa-shield-alt",
                "title": "Web Security",
                "description": "Implementing authentication, authorization, and data encryption"
            }
        ]
    },
    "skillsDetailed": [
        {
            ...
            "description": "Expert in Node.js runtime and Express framework for building efficient server-side applications."
        },
        {
            "icon": "fas fa-database",
            "title": "Database Design",
            "description": "Proficient in SQL (MySQL) and NoSQL (MongoDB) database architecture and query optimization."
        },
        {
            "icon": "fab fa-html5",
            "title": "Frontend Technologies",
            "description": "Strong command of HTML5, CSS3, JavaScript (ES6+), and EJS templating engine."
        },
        {
            "icon": "fas fa-tools",
            "title": "DevOps & Tools",
            "description": "Experience with Git version control, Docker basics, and deployment platforms like Render."
        }
    ],
    "blog": [
        {
            "id": 1,
            "title": "Building Secure Authentication with Node.js",
            "excerpt": "Learn how to implement robust user authentication using bcrypt and sessions in your Express applications.",
            "date": "2024-03-15",
            "readTime": "5 min read",
            "tags": [
                "Node.js",
            ...
            "image": "./resource/blog/security-authentication-bcrypt.jpeg",
            "content": "<p>Security is paramount in modern web applications...</p>"
        },
        {
            "id": 2,
            "title": "Mastering EJS Templating",
            "excerpt": "A comprehensive guide to using Embedded JavaScript templates for dynamic server-side rendering.",
            "date": "2024-03-10",
            "readTime": "4 min read",
            "tags": [
                "EJS",
            ...
            "image": "./resource/blog/ejs-templating-guide.jpeg",
            "content": "<p>EJS is a simple templating language that lets you generate HTML markup with plain JavaScript...</p>"
        },
        {
            "id": 3,
            "title": "RESTful API Best Practices",
            "excerpt": "Key principles for designing scalable and maintainable REST APIs with Node.js and Express.",
            "date": "2024-03-05",
            "readTime": "6 min read",
            "tags": [
                "API",
            ...
            "image": "./resource/blog/restful-api-nodejs.jpeg",
            "content": "<p>Designing a RESTful API requires careful consideration...</p>"
        },
        {
            "id": 4,
            "title": "Optimizing React Performance",
            "excerpt": "Deep dive into techniques for speeding up React apps: useMemo, useCallback, and virtualization.",
            "date": "2024-03-20",
            "readTime": "7 min read",
        ...
        },
        {
            ...
            "excerpt": "Learn how to build flexible and reusable code components using TypeScript Generics.",
            "date": "2024-03-25",
            "readTime": "6 min read",
        ...
        },
        {
            ...
            "excerpt": "A step-by-step guide to containerizing your Node.js apps for consistent deployment environments.",
            "date": "2024-03-28",
            "readTime": "8 min read",
        ...
        {
            "id": 7,
            "title": "Introduction to GraphQL vs REST",
            "excerpt": "Compare the two dominant API architectural styles and decide which one fits your project.",
            "date": "2024-04-02",
            "readTime": "6 min read",
        ...
        {
            "id": 8,
            "title": "Modern CSS Layouts: Grid vs Flexbox",
            "excerpt": "Understand when to use CSS Grid and when to use Flexbox for building responsive layouts.",
            "date": "2024-04-05",
            "readTime": "5 min read",
